...
with io.open('answer.txt', "w", encoding="utf-8") as answer_file:
    ...
    start_model = load_model('best_model_start.model')
    end_model = load_model('best_model_end.model')
    ...
    related_para = load_obj('related_para')
    ...
    for index in range(len(inputs_question)):
        ...
        start = start_model.predict([question_array, para_array, question_pos_array, para_pos_array])
        end = end_model.predict([question_array, para_array, question_pos_array, para_pos_array])
